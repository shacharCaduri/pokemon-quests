...
static const u8 sGymCityMapSecs[(1 + ((((0x4FF + 1) + 768 - 1) + 1) + 0x27) - ((((0x4FF + 1) + 768 - 1) + 1) + 0x20))] = {
    0x5A,
    0x5B,
    0x5D,
    0x5E,
...
static bool8 TryDeferTrainerBattleEvent(u16 eventId, const u16 * data)
{
    ...
    ResetDeferredLinkEvent();
    if (gQuestLogPlaybackState != 0 || FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x2C)) || ShouldRegisterEvent_HandleBeatStoryTrainer(eventId, data) != 1)
    {
        sDeferredEvent.id = eventId;
...
static const u16 *LoadEvent_DepartedLocation(const u16 *eventData)
{
    ...
    {
        for (i = 0; i < (1 + ((((0x4FF + 1) + 768 - 1) + 1) + 0x27) - ((((0x4FF + 1) + 768 - 1) + 1) + 0x20)); i++)
        {
            if (record[0] != sGymCityMapSecs[i])
                continue;
            if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x20) + i) == 1)
        ...
        if (i == (1 + ((((0x4FF + 1) + 768 - 1) + 1) + 0x27) - ((((0x4FF + 1) + 768 - 1) + 1) + 0x20)))
