...
static void BufferPartyVsScreenHealth_AtStart(void)
{
    ...
    for ((i) = 0; (i) < 6; (i)++) { u16 species = GetMonData(&(gPlayerParty)[(i)], 65); u16 hp = GetMonData(&(gPlayerParty)[(i)], 57); u32 status = GetMonData(&(gPlayerParty)[(i)], 55); if (species == 0) continue; if (species != 412 && hp != 0 && status == 0) (flags) |= 1 << (i) * 2; if (species == 0) continue; if (hp != 0 && (species == 412 || status != 0)) (flags) |= 2 << (i) * 2; if (species == 0) continue; if (species != 412 && hp == 0) (flags) |= 3 << (i) * 2; };
...
static void BufferPartyVsScreenHealth_AtEnd(u8 taskId)
{
    ...
    flags = 0;
    for ((i) = 0; (i) < 6; (i)++) { u16 species = GetMonData(&(party1)[(i)], 65); u16 hp = GetMonData(&(party1)[(i)], 57); u32 status = GetMonData(&(party1)[(i)], 55); if (species == 0) continue; if (species != 412 && hp != 0 && status == 0) (flags) |= 1 << (i) * 2; if (species == 0) continue; if (hp != 0 && (species == 412 || status != 0)) (flags) |= 2 << (i) * 2; if (species == 0) continue; if (species != 412 && hp == 0) (flags) |= 3 << (i) * 2; };
    gTasks[taskId].data[3] = flags;

    flags = 0;
    for ((i) = 0; (i) < 6; (i)++) { u16 species = GetMonData(&(party2)[(i)], 65); u16 hp = GetMonData(&(party2)[(i)], 57); u32 status = GetMonData(&(party2)[(i)], 55); if (species == 0) continue; if (species != 412 && hp != 0 && status == 0) (flags) |= 1 << (i) * 2; if (species == 0) continue; if (hp != 0 && (species == 412 || status != 0)) (flags) |= 2 << (i) * 2; if (species == 0) continue; if (species != 412 && hp == 0) (flags) |= 3 << (i) * 2; };
