...
extern const u8 gText_PokeSum_IVs[];
extern const u8 gText_PokeSum_EVs[];
extern const u8 gText_PokeSum_HP[];
extern const u8 gText_PokeSum_ATK[];
extern const u8 gText_PokeSum_DEF[];
extern const u8 gText_PokeSum_SPA[];
extern const u8 gText_PokeSum_SPD[];
extern const u8 gText_PokeSum_SPE[];
